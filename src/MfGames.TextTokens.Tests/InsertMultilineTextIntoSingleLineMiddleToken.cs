// <copyright file="InsertMultilineTextIntoSingleLineMiddleToken.cs" company="Moonfire Games">
...
namespace MfGames.TextTokens.Tests
{
        ...
        MemoryBufferTests
    {
        ...
        /// <summary>
        /// </summary>
        public class Undo : InsertMultilineTextIntoSingleLineMiddleToken
        {
            #region Public Methods and Operators
        ...
        /// <summary>
        /// </summary>
        public class UndoRedo : InsertMultilineTextIntoSingleLineMiddleToken
        {
            #region Methods
        ...
        public class UndoRedoUndoRedo :
            InsertMultilineTextIntoSingleLineMiddleToken
        {
            #region Methods
